                                    ...
                                    <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                        ...
                                        <ul class="color-option">
                                            <li v-for="color in filterList.colors">
                                                <a @click="addColor(color.id)" href="#0" class="color-option-single"
                                                   :style="`background:#${color.title}`"> <span> {{
                                                        color.title
                                                    }}</span></a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="single-sidebar-box mt-30 wow fadeInUp animated pb-0 border-bottom-0 ">
                                        ...
                                        <ul class="popular-tag">
                                            <li v-for="tag in filterList.tags">
                                                <a @click="addTag(tag.id)" href="#0">{{ tag.title }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                                    <ul class="pagination text-center">
                                        <li v-if="pagination.current_page !== 1" class="next"><a
                                            @click.prevent="getProducts(pagination.current_page - 1)" href="#0"><i
...
">
                                                <a @click.prevent="getProducts(link.label)" href="#0"
